google.maps.__gjsload__("map", function (_) {
  var dla = function (a) {
    ...
    Iv = function (a) {
      return (a = _.Ll(a.h)) && _.S(a.o, 2) && _.S(_.J(a.o, 2, Hv).o, 3)
        ? _.J(_.J(a.o, 2, Hv).o, 3, dla)
        : null;
    },
    lla = function (a) {
      if (!a.h) return !1;
    ...
    qla = function (a) {
      ...
      new _.xi(a, "focus", function () {
        b.style.opacity = _.yi
          ? _.wi(a, ":focus-visible")
            ? 1
            : 0
          : !1 === _.zi
          ? 0
    ...
    ula = function (a) {
      if (!a) return null;
      a = a.toLowerCase();
      return sla.hasOwnProperty(a)
        ? sla[a]
        : tla.hasOwnProperty(a)
        ? tla[a]
        : null;
    },
    vla = function (a, b, c) {
    ...
    wla = function (a) {
      var b = _.vh(a.h, { featureType: a.j });
      if (!b.isAvailable && 0 < b.h.length) {
        ...
        _.v(c, "includes").call(
          ...
          ("DATASET" === a.j
            ? (_.P(a.h, "DddsMnp"), _.O(a.h, 177311))
            : (_.P(a.h, "DdsMnp"), _.O(a.h, 148844)));
        if (
          _.v(c, "includes").call(
            c,
          ...
          _.P(a.h, "DtNe"), _.O(a.h, 148846);
        _.v(c, "includes").call(
          c,
          "The map is not a vector map. That will prevent use of data-driven styling."
        ) &&
          ("DATASET" === a.j
            ? (_.P(a.h, "DddsMnv"), _.O(a.h, 177315))
            : (_.P(a.h, "DdsMnv"), _.O(a.h, 148845)));
      }
      return b;
    },
    Lv = function (a, b) {
    ...
    Mv = function (a, b) {
      ...
      _.x.Promise.all([_.Le("webgl"), a.h.__gm.Ba]).then(function (d) {
        _.A(d).next().value.av(a.h, { featureType: a.j }, c);
        a.D = b;
      });
    },
    Nv = function () {
    ...
    Dla = function (a, b, c) {
      ...
      if ((b = Cla(b, c))) d = b;
        ...
        for (var e in a.params)
          (b = _.dn(d)), _.$m(b, e), (c = a.params[e]) && _.an(b, c);
      return d;
    },
    ...
    Fla = function (a, b, c, d, e) {
      ...
      if (e) {
        ...
        if ((c = e.Xt) && !_.cb(c))
          for (
            h || ((h = new _.bn()), _.cn(h, 26), f.push(h)),
    ...
    Rv = function (a, b, c, d, e, f) {
      ...
      if (this.m) {
        ...
        p.push(q);
        b = { wd: Ela(h, k, l, m, p, b, e, f), yf: c, scale: d };
        g.call(a, b);
      }
    },
    Gla = function (a, b, c) {
    ...
    Hla = function (a) {
      ...
      if (
        a.j &&
        ((b = _.hq(_.Wq(a.F, { ja: c + 0.5, ka: d + 0.5, wa: e }), null)),
        !yla(a.j, b))
      ) {
        a.C = !0;
      ...
      (c = a.H({ ja: c, ka: d, wa: e }))
        ? ((c = _.wn(
            _.wn(_.wn(new _.qn(_.Rja(a.G, c)), "x", c.ja), "y", c.ka),
            "z",
            g
          )),
          1 != b && _.wn(c, "w", a.F.size.ea / b),
          f && (b *= 2),
          1 != b && _.wn(c, "scale", b),
    ...
    Vv = function (a, b, c, d) {
      ...
      if ("satellite" == b) {
        ...
        b = new _.$q({ ea: 256, ga: 256 }, e ? 45 : 0, d.heading || 0);
        return new Ila(
          h,
          f && 1 < _.km(),
          _.Cu(d.heading),
    ...
    Lla = function (a) {
      function b(c, d) {
        ...
        var e = d.wd.clone();
        _.cn(_.rt(_.Bt(e)), c);
        return { scale: d.scale, yf: d.yf, wd: e };
      }
      return function (c) {
        var d = Vv(a, "roadmap", a.h, { Qv: !1, Bd: b(3, c.Bd().get()) }),
          e = Vv(a, "roadmap", a.h, { Bd: b(18, c.Bd().get()) });
        d = new Tv([d, e]);
        c = Vv(a, "roadmap", a.h, { Bd: c.Bd().get() });
        return new Jla(d, c);
      };
    },
    Mla = function (a) {
      return function (b, c) {
        var d = b.Bd().get(),
          e = Vv(a, "satellite", null, { heading: b.heading, Bd: d, Jr: !1 });
        b = Vv(a, "hybrid", a.h, { heading: b.heading, Bd: d });
        return new Tv([e, b], c);
      };
    },
    Nla = function (a, b) {
      return new Qv(
        Mla(a),
        a.h,
        "number" === typeof b ? new _.eq(b) : a.C,
    ...
    Rla = function (a, b, c) {
      ...
      if ("hybrid" == b)
        for (
          b = Nla(a), b.h = {}, d = _.A(d), c = d.next();
          !c.done;
          c = d.next()
        )
          (c = c.value), (b.h[c] = Nla(a, c));
      else if ("satellite" == b)
        for (
          b = Pla(a), b.h = {}, d = _.A(d), c = d.next();
          !c.done;
          c = d.next()
        )
          (c = c.value), (b.h[c] = Pla(a, c));
      else
        b =
          "roadmap" == b && 1 < _.km() && c.Iw
            ? new Qv(
                Lla(a),
                a.h,
                a.C,
    ...
    cma = function (a, b, c, d) {
      ...
      _.Kq(c.ug, {
        ...
        Od: function (f) {
          ...
          f = f.Zh;
          3 === h.button
            ? f || bw(e, "rightclick", g, h.Ha)
            : f
            ? bw(e, "dblclick", g, h.Ha, _.mq("dblclick", g, h.Ha))
            : bw(e, "click", g, h.Ha, _.mq("click", g, h.Ha));
        },
        Ug: {
          Ie: function (f, g) {
    ...
    dma = function (a, b, c, d, e) {
      ...
      c = new _.lq(
        h,
        f,
        new _.Q(c.clientX - k.left, c.clientY - k.top),
        new _.Q(g.h, g.j)
      );
    ...
    fma = function (a, b, c, d) {
      return new _.Xq(function (e, f) {
        e = new _.Uq(a, b, c, _.ir(e), f, { qk: !0 });
        c.Bb(e);
        return e;
      }, d);
    },
      ...
      function e(f, g, h) {
        ...
        if (k && null != l && m) {
          var p = a.getTilt() || 0,
            q = a.getHeading() || 0,
            r = _.jj(l, p, q);
          f = _.Zl(_.gq(k, m), _.kj(r, { ea: f, ga: g }));
          c.Hc({ center: f, zoom: l, heading: q, tilt: p }, h);
        }
      }
      ...
      _.L(b, "tiltrotatebynow", function (d, e) {
        ...
        if (f && null != g && h) {
          var k = a.getTilt() || 0,
            l = a.getHeading() || 0;
          c.Hc(
            { center: _.gq(f, h), zoom: g, heading: l + d, tilt: k + e },
            !1
          );
        }
      });
    ...
    wma = function (a, b) {
      if ((a.j = b))
        a.C && a.set("heading", a.C), (b = a.get("mapTypeId")), a.Lj(b);
    },
    iw = function () {},
    xma = function (a, b) {
      this.h = a;
    ...
    Bma = function (a, b, c) {
      if (!a.isEmpty()) {
        ...
        (e || g.length || h) &&
          _.Tm(b, "maptypeid_changed", function () {
            var l = c.j.get();
        ...
        if (a.m ? !a.h : !a.h || d || f) {
          ...
          try {
            ...
            a.map.get("isFractionalZoomEnabled") ||
              Math.round(k) === k ||
              "number" !== typeof k ||
              (_.P(a.map, "BSzwf"), _.O(a.map, 149837));
            if (g && h && null != k && !isNaN(h.lat()) && !isNaN(h.lng())) {
              var l = _.gq(h, g),
                m = !b || b.zoom != k || d || f;
              a.va.Hc({ center: l, zoom: k, tilt: c, heading: e }, a.G && m);
            }
          } finally {
            a.F = !1;
          }
        ...
        b &&
          b.forEach(function (c) {
            c &&
              ...
              ula(c.featureType) &&
              (_.P(a, c.featureType),
              c.featureType in Dma && _.O(a, Dma[c.featureType]));
          });
      } catch (c) {}
    },
    Hma = function (a) {
      ...
      for (var b = [], c = _.A(a), d = c.next(); !d.done; d = c.next()) {
        ...
        null != e &&
          null == h &&
          _.ae(_.$d("invalid style feature type: " + e, null));
        e = f && Fma[f.toLowerCase()];
        (e = null != e ? e : null) && d.push("s.e:" + e);
        null != f &&
          null == e &&
          _.ae(_.$d("invalid style element type: " + f, null));
        if (g)
      ...
      b = b.join(",");
      return b.length > (_.Ei[131] ? 12288 : 1e3)
        ? (_.Wd("Custom style string for " + a.toString()), "")
        : b;
    },
    nw = function () {},
    ow = function (a, b) {
      ...
      b =
        void 0 === b
          ? ((c["X-Goog-Api-Key"] =
              (null == (Ima = _.dg) ? void 0 : _.wd(Ima)) || ""),
            (c["X-Google-Maps-Client-Id"] =
              (null == (Jma = _.dg) ? void 0 : _.kd(Jma.o, 7)) || ""),
      ...
      this.Da = new _.mi(function () {
        ...
        if (!l || _.Sl(l).equals(_.Rl(l))) _.kg(k.j);
          ...
          if ((p = k.F = p)) {
            if (
              ((m = p != m) ||
                (m = (m = k.get("bounds")) ? (k.D ? !k.D.Cf(m) : !0) : !1),
              m)
            ) {
              ...
              p &&
                ...
                (q = k.get("baseMapType")) && q.Dj && k.C && _.D(m.o, 6, q.Dj),
                (p = k.D = vla(p, 1, 10)),
                (q = _.K(m.o, 1, _.sm)),
                (r = _.tm(q)),
                _.qm(r, p.getSouthWest().lat()),
                _.rm(r, p.getSouthWest().lng()),
                (q = _.um(q)),
                _.qm(q, p.getNorthEast().lat()),
                _.rm(q, p.getNorthEast().lng()),
                k.H && k.J
                  ? ((k.J = !1),
                    _.D(m.o, 12, 1),
    ...
    Nma = function (a, b, c) {
      ...
      _.uu(
        _.mk,
        _.Zu + "/maps/api/js/ViewportInfoService.GetViewportInfo",
        _.vj,
        d,
        function (e) {
          try {
    ...
    Cw = function (a, b) {
      ...
      a &&
        ((this.h = _.xn(this.j).createElement("div")),
      ...
      this.F &&
        b &&
        (this.m = _.bf(b, "mousemove", (0, _.Oa)(this.D, this), !0));
      this.title_changed();
    },
    ...
    Yma = function (a, b) {
      return { cb: a.va.md(b.cb), radius: b.radius, zoom: a.va.uc().zoom };
    },
        ...
        Od: function (q) {
          ...
          q.Zh &&
            ...
            p.enabled() &&
              ((q = p.j(4)),
              "none" !== q &&
                ((t = p.va.uc().zoom + (t ? -1 : 1)),
                p.h() || (t = Math.round(t)),
                (r = "zoomaroundcenter" === q ? p.va.uc().center : p.va.md(r)),
                Xma(p.va, t, r),
                p.Pd(1))));
        },
      };
    ...
    $ma = function (a, b) {
      return { cb: b.cb, iz: a.va.uc().tilt, hz: a.va.uc().heading };
    },
    ana = function (a, b, c) {
      this.j = a;
      this.m = b;
    ...
    bna = function (a, b, c) {
      ...
      var d = a.width || 1,
        e = a.height || 1;
      a = new ana(b.center.h / d, b.center.j / e, 0.5 * Math.pow(2, -b.zoom));
      d = new ana(c.center.h / d, c.center.j / e, 0.5 * Math.pow(2, -c.zoom));
      ...
      if (this.h.zoom < this.Ra.zoom)
        for (;;) {
          ...
          this.ai.push(
            (Math.abs(b - this.h.zoom) / Math.abs(this.Ra.zoom - this.h.zoom)) *
              this.Eb
          );
        }
    ...
    ina = function (a, b, c, d) {
      ...
      for (
        var l = _.A(_.v(Object, "values").call(Object, a.Ea)), m = l.next();
        !m.done;
        m = l.next()
      )
        m.value.Gb(
    ...
    Kw = function (a, b, c) {
      return {
        center: _.Zl(
          c,
          _.kj(
            _.jj(b, a.tilt, a.heading),
            _.cm(_.jj(a.zoom, a.tilt, a.heading), _.$l(a.center, c))
          )
        ),
        zoom: b,
        heading: a.heading,
    ...
    kna = function (a, b, c) {
      return a.h.na.heading !== b.heading && c
        ? 3
        : a.C
        ? a.h.na.zoom !== b.zoom && c
          ? 2
          : 1
        : 0;
    },
    ...
    mna = function (a, b, c, d) {
      ...
      this.m = a;
      this.j = d;
      this.Ra = { center: b, heading: a.heading, tilt: a.tilt, zoom: c };
    },
    nna = function (a, b, c) {
      this.ai = [];
      var d =
    ...
    rna = function (a, b, c) {
      ...
      return new pna(
        function (f) {
          return new jna(a, f, { um: e });
        },
        function (f, g, h, k) {
          return new dna(new bna(f, g, h), { Xc: k, maxDistance: d ? 1.5 : 0 });
        },
        b
      );
    },
    sna = function (a, b, c) {
      _.Hd(_.hfa, function (d, e) {
        b.set(e, Rla(a, e, { Iw: c }));
      });
    },
    tna = function (a, b) {
      _.Tm(b, "basemaptype_changed", function () {
    ...
    vna = function (a) {
      ...
      if (b) {
        ...
        _.ef(a, "embedreportoncelog_changed", function () {
          vna(a);
        });
    },
    wna = function (a) {
      ...
      if (b) {
        ...
        _.ef(a, "embedfeaturelog_changed", function () {
          wna(a);
        });
    },
    Ow = function () {};
      ...
      set: function (a) {
        ...
        if (void 0 === a || null === a) a = b;
          ...
          try {
            ...
            if (c instanceof _.Zd)
              throw _.$d("google.maps.FeatureLayer.style", c);
            throw c;
          }
          a = b;
        }
        ...
        Lv(this, "google.maps.FeatureLayer.style").isAvailable &&
          (Mv(this, this.m),
          "DATASET" === this.j
            ? (_.P(this.h, "DflSs"), _.O(this.h, 177294))
            : (_.P(this.h, "MflSs"), _.O(this.h, 151555)));
      },
    },
    isEnabled: {
      configurable: !0,
  ...
  Tv.prototype.Cc = function (a, b) {
    ...
    return new Sv(c, d, this.ab.size, this.h, { Xb: b.Xb });
  };
  ...
  var xna = [
    { bn: 108.25, an: 109.625, gn: 49, en: 51.5 },
    { bn: 109.625, an: 109.75, gn: 49, en: 50.875 },
    { bn: 109.75, an: 110.5, gn: 49, en: 50.625 },
    { bn: 110.5, an: 110.625, gn: 49, en: 49.75 },
  ];
    ...
    a: {
      ...
      if (!(7 > c)) {
        ...
        for (var e = _.A(xna), f = e.next(); !f.done; f = e.next())
          if (
            ((f = f.value), c >= f.bn && c <= f.an && d >= f.gn && d <= f.en)
          ) {
            c = !0;
            break a;
          }
  ...
  cw.Yw = function (a, b, c, d) {
    ...
    c = Math.min(
      _.Mm(c.width + 1e-12) - _.Mm(a + 1e-12),
      _.Mm(c.height + 1e-12) - _.Mm(e + 1e-12)
    );
    d || (c = Math.floor(c));
    return c;
  };
    ...
    if (!this.j) {
      ...
      if ("number" === typeof a) {
        ...
        a != b
          ...
          : ((a = this.get("mapTypeId")), this.Lj(a));
      }
    }
  };
  ...
  _.n.Lj = function (a) {
    ...
    (c && c == this.J) ||
      (this.F && (_.Te(this.F), (this.F = null)),
      (b = (0, _.Oa)(this.Lj, this, a)),
            ...
            (b = b.j.get()),
              ...
              (c =
                b == c
                  ...
                  ? b.scale == c.scale &&
                    b.yf == c.yf &&
                    (b.wd == c.wd ? !0 : b.wd && c.wd ? b.wd.equals(c.wd) : !1)
                  : !1);
          b = c;
        } else b = !1;
  ...
  xma.prototype.moveCamera = function (a) {
    ...
    if ((b || a.center) && e && d) {
      ...
      this.D.Hc({ center: a, zoom: c, heading: g, tilt: f }, !1);
    }
  };
  _.B(jw, _.N);
  _.n = jw.prototype;
  ...
  mw.prototype.getBounds = function () {
    ...
    if (a && null != b) {
      ...
      a = { center: _.gq(a, e), zoom: b, tilt: c, heading: d };
      a = this.va.co(a);
      e = _.wia(a, e, !0);
    } else e = null;
    return e;
  ...
  nw.prototype.changed = function (a) {
    if ("apistyle" != a && "hasCustomStyles" != a) {
      ...
      for (var d = _.Td(void 0, _.Gd(b)), e = _.Td(void 0, 0); e < d; ++e)
        c.push(b[e]);
      d = this.get("uDS")
      ...
      c.length &&
        (!d || 1e3 < d.length) &&
        _.Tg(_.cl(_.M, this, "styleerror", d.length));
      "styles" === a && Ema(this, b);
    }
  };
  ...
  qw.prototype.changed = function (a) {
    "attributionText" != a &&
      ("baseMapType" == a && (Oma(this), (this.F = null)), _.ni(this.Da));
  };
  qw.prototype.T = function (a, b, c) {
    1 == _.H(c.o, 8) &&
      (0 !== c.getStatus() && _.jg(this.j, 14), this.W(_.J(c.o, 7, _.$p), !1));
    if (a == this.G) {
      if (pw(this) == b)
        try {
      ...
      if (this.h && this.C) {
        ...
        if (1 == a.nodeType) {
          ...
          (b = a.changedTouches ? a.changedTouches[0] : a),
            (b = new _.Pm(b.clientX, b.clientY));
  ...
  Dw.prototype.Ie = function (a, b) {
    ...
    if (!this.active) {
      ...
      d
        ? (this.active = { origin: a.cb, jz: this.va.uc().zoom, We: d })
        : this.h.reset(b);
    }
  };
  Dw.prototype.Of = function (a) {
    if (this.active) {
      ...
      this.active.We.Bi({
        center: b.center,
        zoom:
          this.active.jz + (a.cb.clientY - this.active.origin.clientY) / 128,
        heading: b.heading,
        tilt: b.tilt,
      });
    }
  ...
  Ew.prototype.Ie = function (a, b) {
    ...
    "none" === e ||
      ...
      (b.stop(),
      this.active
        ? (this.active.Qf = Yma(this, a))
        : (this.cursor && _.Du(this.cursor, !0),
          (d = Nw(this.va, function () {
            c.active = null;
            c.j.reset(b);
          }))
            ? (this.active = { Qf: Yma(this, a), We: d })
            : this.j.reset(b)));
  };
  Ew.prototype.Of = function (a) {
    if (this.active) {
      ...
      if ("none" !== b) {
        var c = this.va.uc();
        b =
          "zoomaroundcenter" === b && 1 < a.me
            ? c.center
            : _.$l(_.Zl(c.center, this.active.Qf.cb), this.va.md(a.cb));
        this.active.We.Bi({
          center: b,
          zoom:
            this.active.Qf.zoom +
    ...
    if ("none" !== e && ("cooperative" !== e || !d))
      if ((b.stop(), this.active)) {
        if (
          ...
          (this.m = 0),
          (this.j = a.Og),
          2 === this.active.Th || 3 === this.active.Th)
        )
          this.active.Th = 0;
      } else
        this.cursor && _.Du(this.cursor, !0),
    ...
    if (this.active) {
      ...
      if ("none" !== b) {
        ...
        179 <= Math.round(Math.abs(d)) &&
          ((this.j = this.j < a.Og ? this.j + 360 : this.j - 360),
          (d = this.j - a.Og));
        this.m += d;
        ...
        if (1 === e || 2 === e || 3 === e) d = e;
          ...
          d = e
            ? 3
            : this.G &&
              (("cooperative" === b && 3 !== a.me) ||
              ("greedy" === b && 2 !== a.me)
                ? 0
                : 15 <= Math.abs(d.cb.clientY - a.cb.clientY) && 20 >= f)
            ? 2
            : 0;
        }
        d !== this.active.Th &&
          ((this.active.Th = d), (this.h = Hw(this, a)), (this.m = 0));
        f = c.center;
        e = c.zoom;
        var g = c.heading,
          h = c.tilt;
        switch (d) {
          ...
          case 1:
            f =
              "zoomaroundcenter" === b && 1 < a.me
                ? c.center
                : _.$l(_.Zl(c.center, this.h.Ll), this.va.md(a.cb));
        ...
        this.j = a.Og;
        this.active.We.Bi({ center: f, zoom: e, heading: g, tilt: h });
      }
    }
  };
  Gw.prototype.jf = function () {
    ...
    this.cursor && _.Du(this.cursor, !1);
    this.active &&
      (this.Pd(this.active.Th),
      this.active.We.release(this.h ? this.h.Ll : void 0));
    this.h = this.active = null;
    this.m = this.j = 0;
  };
  Iw.prototype.Ie = function (a, b) {
    ...
    if (this.active) this.active.Qf = $ma(this, a);
      ...
      d ? (this.active = { Qf: $ma(this, a), We: d }) : this.h.reset(b);
    }
  };
  ...
  bna.prototype.ib = function (a) {
    ...
    return {
      center: new _.gj(
        this.h.center.h * (1 - b) + this.Ra.center.h * b,
        this.h.center.j * (1 - b) + this.Ra.center.j * b
      ),
    ...
    if (!this.h) {
      ...
      this.h =
        ...
        (c < b.j
          ...
          : b.m + (c - b.j) / b.speed);
      return { done: 1, na: this.cc.ib(0) };
    }
    a >= this.h
      ? (a = { done: 0, na: this.cc.Ra })
      : ((b = this.easing),
        (a = this.h - a),
        (a = {
          done: 1,
  ...
  _.n.Hc = function (a, b) {
    ...
    this.na && b
      ? this.sg(
          this.F(this.Ea.getBoundingClientRect(!0), this.na, a, function () {})
        )
      : this.sg(ena(a));
  };
  _.n.eo = function () {
    return this.instructions
      ? this.instructions.cc
        ? this.instructions.cc.Ra
        : null
      : this.na;
  };
  _.n.hm = function () {
  ...
  _.n.Bp = function (a) {
    ...
    !this.instructions &&
      this.na &&
      ((a = this.h.zj(this.na)),
      (a.center === this.na.center &&
        a.zoom === this.na.zoom &&
        a.heading === this.na.heading &&
        a.tilt === this.na.tilt) ||
        this.sg(ena(a)));
  };
  _.n.xk = function () {
  ...
  _.n.Ik = function () {
    this.Ea.Ik();
    this.instructions && this.instructions.cc
      ? this.j(this.h.zj(this.instructions.cc.Ra))
      : this.na && this.j(this.na);
  };
  _.n = jna.prototype;
  _.n.Bb = function (a) {
    var b = _.Na(a);
  ...
  _.n.getBounds = function (a, b) {
    ...
    if (this.j) {
      ...
      b = this.j.Aj(c, g, k, l, m, a, h);
      c = this.j.Aj(c, e, k, l, m, a, h);
    } else
      (h = _.jj(a.zoom, a.tilt, a.heading)),
        (f = _.Zl(a.center, _.kj(h, { ea: b, ga: g }))),
        (d = _.Zl(a.center, _.kj(h, { ea: c, ga: g }))),
        (c = _.Zl(a.center, _.kj(h, { ea: c, ga: e }))),
        (b = _.Zl(a.center, _.kj(h, { ea: b, ga: e })));
    return {
  ...
  _.n.Gb = function (a, b, c) {
    ...
    if ((f || this.j) && this.offset)
      this.origin = fla(e, _.Zl(d, _.kj(e, this.offset)));
    else if (
      ((this.offset = _.bm(_.cm(e, _.$l(this.origin, d)))), (d = this.F))
    )
    ...
    for (
      var g = this.getBoundingClientRect(!0),
        h = _.A(_.v(Object, "values").call(Object, this.Ea)),
        k = h.next();
      !k.done;
      k = h.next()
    )
  ...
  Lw.prototype.ib = function () {
    return { na: this.na, done: this.Xb ? 2 : 0 };
  };
  Lw.prototype.Bi = function (a) {
    ...
    this.h = { oc: b, na: a };
    (0 < this.j.length && 10 > b - this.j.slice(-1)[0].oc) ||
      (this.j.push({ oc: b, na: a }),
    ...
    if (!(0 >= this.j.length) && this.h) {
      ...
      switch (kna(this, d.na, a)) {
        case 3:
          a = new ona(
            this.h.na,
            -180 + _.Im(this.h.na.heading - d.na.heading - -180, 360),
            e,
            c,
            a || this.h.na.center
          );
  ...
  Mw.prototype.ib = function (a) {
    a -= this.startTime;
    return { na: this.cc.ib(a), done: a < this.cc.Eb ? 1 : 0 };
  };
  lna.prototype.ib = function (a) {
    ...
    return {
      center: _.$l(
        this.Ra.center,
        new _.gj(this.h * a * a * a, this.j * a * a * a)
      ),
  ...
  Ow.prototype.h = function (a, b, c, d, e, f) {
    ...
    if (k) {
      ...
      if ((k = b.mapId || null))
        _.P(a, "MId"),
          _.O(a, 150505),
          k === _.nfa && (_.P(a, "MDId"), _.O(a, 168942));
      ...
      var ha = ama({
        ...
        Eb = new _.Xq(function (ia, Da) {
          ia = new _.Uq(m, 0, Ia, _.ir(ia), Da, { qk: !0 });
          Ia.Bb(ia);
          return ia;
        }, Ga),
        Lc = _.kr();
      ...
      e({ map: a, va: Ia, Oh: b, yg: l.yg });
      h.D.then(function (ia) {
        ia ||
          _.Le("onion").then(function (Da) {
            Da.j(a, t);
          });
      });
      _.Ei[35] && (vna(a), wna(a));
      ...
      var hb = new _.iq(a, Ia, function () {
          ...
          if (hb.D && hb.C && hb.h && hb.m && hb.j) {
            if (hb.h.h) {
              ...
              (Za = _.cm(hb.h, _.$l(hb.D.min, hb.C))),
                (Da = _.cm(hb.h, _.$l(hb.D.max, hb.C))),
                (Za = new _.Q(Za.ea, Za.ga)),
                (Da = new _.Q(Da.ea, Da.ga));
            Za = new _.oi([Za, Da]);
          } else Za = null;
      ...
      d &&
        (_.Ul(d.m, function () {
          ...
          Ha ||
            !ia ||
            Fa ||
            ((Ha = new _.Qu(m, -1, ia, Ia.bc)), d.j && _.lj(d.j), Ia.Bb(Ha));
        }),
        d.bindTo("tilt", h),
        d.bindTo("size", h));
      h.bindTo("zoom", a);
      ...
      X = new _.wu({ projection: new _.Oi() });
      X.bindTo("projection", e);
      a.bindTo("projection", X);
      qma(a, h, Ia, Aa);
      rma(a, h, Ia);
      var Lb = new xma(a, Ia);
      _.L(h, "movecamera", function (ia) {
        Lb.moveCamera(ia);
      });
      h.D.then(function (ia) {
        Lb.C = ia ? 2 : 1;
        if (void 0 !== Lb.m || void 0 !== Lb.j)
          Lb.moveCamera({ tilt: Lb.m, heading: Lb.j }),
            (Lb.m = void 0),
            (Lb.j = void 0);
      });
      var hc = new tw(Ia, a);
