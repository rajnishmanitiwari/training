google.maps.__gjsload__("controls", function (_) {
      ...
      : _.$ga(a, b) &&
        _.Zga(
          ...
          Array.prototype.filter
            .call(
              a.classList ? a.classList : _.jn(a).match(/\S+/g) || [],
              function (c) {
                return c != b;
              }
            )
  ...
  Sua = function (a, b) {
    ...
    if (!c) {
      ...
      c = d;
      void 0 === a.style[d] &&
        ((d = _.fz() + _.toa(d)), void 0 !== a.style[d] && (c = d));
      Rua[b] = c;
    }
    return c;
  };
          ...
          if (g) {
            ...
            "roadmap" == f
              ? d &&
                ...
                (h = [[this.h]]),
                (this.D = a.get("terrain").maxZoom))
              : ("satellite" != f && "hybrid" != f) ||
                !e ||
                ((this.j = Vua(this)), (h = [[this.j]]));
  ...
  Uua = function (a, b, c, d, e, f) {
    ...
    a.m[b] = { mapTypeId: c, Nk: d, value: !0 };
    a.m[c] = { mapTypeId: c, Nk: d, value: !1 };
    return e;
  };
  tG = function (a) {
    this.j = a;
  ...
  hva = function (a, b) {
    ...
    for (var c = 0; c < a.C.length; c++)
      a.coords[c] = (a.F[c] - a.C[c]) * b + a.C[c];
  };
  iva = function (a, b) {
    _.Fh.call(this, a);
  ...
  FG = function (a, b, c, d) {
    ...
    b = _.A(
      b
        ? 1 == c
          ? [
              _.Mq["fullscreen_exit_normal_dark.svg"],
              _.Mq["fullscreen_exit_hover_dark.svg"],
              _.Mq["fullscreen_exit_active_dark.svg"],
            ]
          : [
              _.Mq["fullscreen_exit_normal.svg"],
              _.Mq["fullscreen_exit_hover.svg"],
              _.Mq["fullscreen_exit_active.svg"],
            ]
        : 1 == c
        ? [
            _.Mq["fullscreen_enter_normal_dark.svg"],
            _.Mq["fullscreen_enter_hover_dark.svg"],
            _.Mq["fullscreen_enter_active_dark.svg"],
          ]
        : [
            _.Mq["fullscreen_enter_normal.svg"],
            _.Mq["fullscreen_enter_hover.svg"],
            _.Mq["fullscreen_enter_active.svg"],
          ]
    );
  ...
  qva = function (a, b, c, d) {
    ...
    this.j &&
      ...
      nG(this.h, _.Om(_.oB(d))),
      (this.h.style.width = this.h.style.height = _.Om(d)),
      _.Sy(this.h, "0 1px 4px -1px rgba(0,0,0,0.3)"),
      (a = this.get("controlStyle") || 0),
      FG(this.h, this.td.get(), a, d),
      (this.h.style.overflow = "hidden"),
      _.bf(this.h, "click", function (f) {
        ...
        if (e.td.get()) {
          ...
          f = _.A(_.Kfa);
          for (g = f.next(); !g.done; g = f.next())
            e.D.push(_.bf(document, g.value, e.F));
          f = e.m;
          g = _.A(_.Mfa);
    ...
    _.L(this, "controlstyle_changed", function () {
      ...
      null != f &&
        ((e.h.style.backgroundColor = ova[f].backgroundColor),
        e.j && FG(e.h, e.td.get(), f, e.C));
    });
  ...
  JG = function (a, b, c) {
    ...
    a = new Image();
    a.src =
      1 === this.m ? _.Mq["keyboard_icon.svg"] : _.Mq["keyboard_icon_dark.svg"];
    a.alt = "";
    a.style.height = "10px";
    a.style.width = "16px";
  ...
  KG = function (a, b, c) {
    ...
    this.h = [];
    this.m = (this.j = 3 === b || 12 === b || 6 === b || 9 === b)
      ? Jua.bind(this)
      : _.jb.bind(this);
  ...
  zva = function (a, b) {
    _.OE(
      a.j,
      b ? _.Mq["google_logo_white.svg"] : _.Mq["google_logo_color.svg"]
    );
  };
  yva = function (a) {
    a.F && a.D.get("passiveLogo")
      ? a.m.contains(a.h)
        ? a.m.replaceChild(a.C, a.h)
        : a.m.appendChild(a.C)
      : (a.h.appendChild(a.C), a.m.appendChild(a.h));
  };
  Ava = function (a, b, c) {
    function d() {
  ...
  QG = function (a, b, c, d, e) {
    ...
    d.Px
      ? ((a = document.createElement("span")),
        (a.style.position = "relative"),
        _.Bn(a, new _.Q(3, 0), !_.hv.Ob(), !0),
        a.appendChild(b),
        this.h.appendChild(a),
        (b = _.NE(_.om("arrow-down"), this.h)),
        _.Bn(b, new _.Q(8, 0), !_.hv.Ob()),
        (b.style.top = "50%"),
        (b.style.marginTop = _.Om(-2)),
        this.set("active", !1),
    ...
    d.Ko ||
      ...
      (d = this.h.offsetWidth - this.m - (_.Vw(this.j.paddingRight) || 0)),
      (this.j.fontWeight = ""),
      _.Od(d) && 0 <= d && (this.j.minWidth = _.Om(d)));
    new _.xi(this.h, "click", function (g) {
      !1 !== f.get("enabled") && _.M(f, "click", g);
    });
    new _.xi(this.h, "keydown", function (g) {
  ...
  PG = function (a, b) {
    ...
    0 == a.get("enabled")
      ...
      : ((a.j.color = c || b ? "#000" : "#565656"),
        a.C && a.h.setAttribute("aria-checked", c));
  ...
  SG = function (a, b, c, d, e) {
    ...
    this.j.style["-webkit-mask-image"] =
      'url("' + _.Mq["checkbox_checked.svg"] + '")';
    this.m = document.createElement("span");
    this.m.style["mask-image"] = 'url("' + _.Mq["checkbox_empty.svg"] + '")';
    this.m.style["-webkit-mask-image"] =
      'url("' + _.Mq["checkbox_empty.svg"] + '")';
    a = _.Cn("span", this.h);
  ...
  UG = function (a, b, c, d, e, f) {
    ...
    for (a.setAttribute("aria-labelledby", e); _.Gd(c); ) {
      e = c.shift();
      f = _.A(e);
      for (b = f.next(); !b.done; b = f.next()) {
        ...
        null != b.m
          ? (g = new SG(a, b.label, b.h, b.m, h))
          : (g = new TG(a, b.label, b.h, h));
  ...
  Jva = function (a) {
    ...
    if (!b.h) {
      ...
      b.h = [
        ...
        _.Sm(c, "mouseover", a, a.F),
        _.bf(document.body, "click", function (e) {
          for (e = e.target; e; ) {
            if (e == c) return;
            e = e.parentNode;
          }
    ...
    if (a.D.contains(document.activeElement)) {
      var d = _.v(a.m, "find").call(a.m, function (e) {
  ...
  Lva = function (a, b, c, d, e, f) {
    ...
    h = _.Ii(g);
    c.j &&
      ((e = new UG(a, g, c.j, a.m, b.jb(), {
        position: new _.Q(f ? 0 : d, h.height),
        Mz: f,
      })),
      Ova(g, b, e));
    a.j.push({ parentNode: g, Wr: e });
    return (d += h.width);
  };
  Kva = function (a) {
    var b = a.get("mapSize");
  ...
  VG = function (a, b, c) {
    ...
    for (var k = b.next(); !k.done; k = b.next())
      (k = k.value),
        "mapTypeId" == k.hf && (g[k.h] = k.label),
        k.j && h.push.apply(h, _.na(k.j));
  ...
  Vva = function (a, b, c) {
    ...
    b = _.A(
      b
        ? [
            _.Mq["tilt_45_normal.svg"],
            _.Mq["tilt_45_hover.svg"],
            _.Mq["tilt_45_active.svg"],
          ]
        : [
            _.Mq["tilt_0_normal.svg"],
            _.Mq["tilt_0_hover.svg"],
            _.Mq["tilt_0_active.svg"],
          ]
    );
    for (var d = b.next(); !d.done; d = b.next()) {
      d = d.value;
  ...
  Wva = function (a, b, c) {
    for (
      var d = _.A([
          _.Mq["rotate_right_normal.svg"],
          _.Mq["rotate_right_hover.svg"],
          _.Mq["rotate_right_active.svg"],
        ]),
        e = d.next();
      !e.done;
      e = d.next()
  ...
  awa = function (a, b, c) {
    ...
    _.Ph(a, "click", function (e) {
      ...
      aH(d);
      _.Ty(e)
        ? (_.P(window, "Scmi"), _.O(window, 165091))
        : (_.P(window, "Scki"), _.O(window, 167511));
    });
  ...
  aH = function (a) {
    ...
    b &&
      ((b *= 80),
      (b = a.m ? bwa(b / 1e3, b, !0) : bwa(b / 1609.344, 3.28084 * b, !1)),
      (a.D.textContent = b.Dw + "\u00a0"),
      a.fa.setAttribute("aria-label", b.Ns),
      (a.fa.title = b.Ns),
      (a.h.style.width = _.gz(b.mz + 4, !0)),
      _.M(a.fa, "resize"));
  };
  bwa = function (a, b, c) {
    var d = a,
  ...
  bH = function (a, b, c, d) {
    ...
    b = _.A(
      0 === b
        ? 2 === c
          ? [
              _.Mq["zoom_in_normal_dark.svg"],
              _.Mq["zoom_in_hover_dark.svg"],
              _.Mq["zoom_in_active_dark.svg"],
              _.Mq["zoom_in_disable_dark.svg"],
            ]
          : [
              _.Mq["zoom_in_normal.svg"],
              _.Mq["zoom_in_hover.svg"],
              _.Mq["zoom_in_active.svg"],
              _.Mq["zoom_in_disable.svg"],
            ]
        : 2 === c
        ? [
            _.Mq["zoom_out_normal_dark.svg"],
            _.Mq["zoom_out_hover_dark.svg"],
            _.Mq["zoom_out_active_dark.svg"],
            _.Mq["zoom_out_disable_dark.svg"],
          ]
        : [
            _.Mq["zoom_out_normal.svg"],
            _.Mq["zoom_out_hover.svg"],
            _.Mq["zoom_out_active.svg"],
  ...
  dH = function (a, b, c, d) {
    ...
    _.L(this, "maptypeid_changed", function () {
      ...
      e.set(
        "controlStyle",
        (("satellite" === f || "hybrid" === f) && _.Ei[43]) || "streetview" == f
          ? 2
          : 1
      );
    });
    _.L(this, "controlstyle_changed", function () {
      ...
      if (null != f) {
        ...
        e.m.style.backgroundColor = g.Rr;
      }
    });
  };
  ewa = function (a, b, c) {
  ...
  mH = function (a, b) {
    ...
    this.j = { Do: null, active: null, Co: null };
    this.h = b;
    this.m = !0;
    jwa(this);
  ...
  qwa = function (a) {
    ...
    return _.ya(function (e) {
      ...
      if (c) {
        var g = a.j() - 3;
        g = Tua(a.N, g);
      } else 7 === b ? ((g = owa(a)), a.H !== g && ((a.H = g), (a.G = { url: pwa[g], scaledSize: new _.Hg(49, 52), anchor: new _.Q(25, 35) })), (g = a.G)) : (g = void 0);
  ...
  swa = function (a, b, c) {
    ...
    f = {};
    for (
      var g = _.A(["dragstart", "drag", "dragend"]), h = g.next();
      !h.done;
      f = { rl: f.rl }, h = g.next()
    )
      (f.rl = h.value),
    ...
    _.L(e, "position_changed", function () {
      ...
      (k = c({ clientX: k.x + a.offset.x, clientY: k.y + a.offset.y })) &&
  ...
  qH = function (a, b) {
    ...
    Fua(this.anchor, "Report problems with Street View imagery to Google");
  };
  pH = function () {
  ...
  rH = function (a) {
    ...
    this.K = a.ao;
    this.rb = _.Lq("Toggle fullscreen view");
    this.V = null;
    this.cd = a.qm;
    this.N = null;
    this.Wa = !1;
  ...
  Dwa = function (a) {
    if (a.j) {
      ...
      _.Ei[17] &&
        (a.T.bindTo("visible", a.j, "reportErrorControl"),
        a.j.bindTo("rmiLinkData", a.T));
    }
  };
  Jwa = function (a) {
  ...
  sH = function (a) {
    var b = a.get("streetViewControl"),
      ...
      d = !!a.get("size");
    if (void 0 !== b || c)
      _.P(a.h, b ? "Cvy" : "Cvn"), _.O(a.h, b ? 148260 : 148261);
    null == b && (b = !c);
    a = d && !a.j;
    return b && a;
  };
  ...
  Fwa = function (a) {
    if (a.h) {
      ...
      a.m.bindTo("bounds", a);
      _.Ei[17]
        ? (a.m.bindTo("enabled", a, "reportErrorControl"),
          a.h.bindTo("rmiLinkData", a.m))
        : a.m.set("enabled", !0);
  ...
  zwa = function (a) {
    ...
    if (a.La && !a.Ja) {
      ...
      if (b) {
        ...
        e.bindTo("zoom", a);
        var f = e.C;
        a.H.addElement(c, d.position || 1, !1, 0.2);
        d = null;
        2 == b
          ? ((d = new VG(c, f, a.C)), e.bindTo("mapTypeId", d))
          : (d = new Mva(c, f, _.RG, a.C));
        b = a.ra = new WG(e.m);
        b.set("labels", !0);
  ...
  Twa = function (a) {
    ...
    if ((void 0 === c && d) || (void 0 !== c && !c))
      return _.P(a.h, "Cmn"), _.O(a.h, 148251), null;
    1 == b
      ? (_.P(a.h, "Cmh"), _.O(a.h, 148253))
      : 2 == b && (_.P(a.h, "Cmd"), _.O(a.h, 148252));
    return 2 == b || 1 == b ? b : 1;
  };
  Uwa = function (a, b) {
  ...
  ywa = function (a) {
    function b(m, p) {
      if (!l[m]) {
        ...
        10 === m || 11 === m || 12 === m || 6 === m || 9 === m
          ? _.kn(t, "gm-bundled-control-on-bottom")
          : _.lG(t, "gm-bundled-control-on-bottom");
        t.style.margin = _.Om(q);
        _.En(t);
        l[m] = new KG(t, m, r);
        a.H.addElement(t, m, !1, 0.1);
      }
      m = l[m];
      m.add(p);
      a.Ba.push({ ta: p, vm: m });
    ...
    for (var d = _.A(a.Ba), e = d.next(); !e.done; e = d.next())
      Swa(a, e.value);
    a.Ba = [];
    d = a.xb = Mwa(a);
    var f = (a.pc = Lwa(a)),
  ...
  Mwa = function (a) {
    ...
    if (void 0 !== b || c)
      return (
        a.j || (_.P(a.h, b ? "Cpy" : "Cpn"), _.O(a.h, b ? 148255 : 148254)), !!b
      );
    b = a.get("size");
  ...
  Nwa = function (a) {
    var b = a.get("rotateControl"),
      c = tH(a);
    if (void 0 !== b || c)
      _.P(a.h, b ? "Cry" : "Crn"), _.O(a.h, b ? 148257 : 148256);
  ...
  Lwa = function (a) {
    ...
    return 0 == b || (c && void 0 === b)
      ? (a.j || (_.P(a.h, "Czn"), _.O(a.h, 148262)), null)
      : a.get("size")
      ? 1
      : null;
  };
  vH = function (a) {
    if (a.Z) {
      ...
      void 0 !== b &&
        (_.P(a.h, b ? "Csy" : "Csn"), _.O(a.h, b ? 148259 : 148258));
  ...
  Ewa = function (a) {
    if (a.h) {
      ...
      a.Z = new awa(
        ...
        _.GG(b, a.K),
        new _.jq(
          [_.mr(a, "projection"), _.mr(a, "bottomRight"), _.mr(a, "zoom")],
          Iua
        )
      );
      vH(a);
  ...
  BH = function (a, b, c, d) {
    for (var e = 0, f = 0, g = _.A(a), h = g.next(); !h.done; h = g.next()) {
      ...
      "left" === b
        ? (k.style.left = "0")
        : "right" === b
        ? (k.style.right = _.Om(l - p))
        : (k.style.left = _.Om((c - p) / 2));
      e += m;
      h || (f = Math.max(l, f));
    }
    b = (d - e) / 2;
  ...
  dxa = function (a, b, c, d, e, f, g, h, k, l, m, p, q, r, t, u, w) {
    ...
    if (y && k) {
      ...
      _.Tm(b, "idle", function () {
        var R = b.get("bounds");
        R != I && (z.set("bounds", R), G.set("bounds", R), (I = R));
        R = b.get("center");
  ...
  jxa = function (a, b, c, d, e) {
    ...
    _.Tm(a, "streetview_changed", function () {
      ...
      h = null;
      k &&
        (h = _.Tm(k, "visible_changed", function () {
          k.getVisible() && k === g
  ...
  ixa = function (a, b, c, d) {
    c = new _.iF({ jg: d, kg: c, ownerElement: b, jl: !1, Ci: "map" });
    var e = _.ck();
    c.element.id = e;
  ...
  DG.prototype.changed = function () {
    ...
    if (a) {
      ...
      _.wl(_.K(b.o, 8, _.mz), _.nz(_.qb(_.Mq["compass_rotate_hover.svg"])));
  ...
  _.B(qva, _.N);
  var ova = [
    { Uw: -52, close: -78, top: -86, backgroundColor: "#fff" },
    { Uw: 0, close: -26, top: -86, backgroundColor: "#222" },
  ];
  var rva = _.jl(
    _.Ya(
  ...
  _.n.qh = function () {
    this.get("keyboardShortcutsShown") &&
      ((this.fa.style.display = ""),
      (this.h.textContent = ""),
      (this.h.textContent = "Keyboard shortcuts"),
      _.cz(),
      _.M(this, "update"));
  };
  _.n.Sb = function () {
    this.get("keyboardShortcutsShown") ||
      ((this.fa.style.display = "none"), _.M(this, "update"));
  };
  _.n.Kd = function () {
    return this.fa;
  };
  ...
  KG.prototype.remove = function (a) {
    ...
    Jua(this.h, function (c, d) {
      c.element === a &&
        (b.h.splice(d, 1), c && (LG(b, c), c.wp && (_.Te(c.wp), delete c.wp)));
    });
  };
  ...
  MG.prototype.changed = function (a) {
    if ("url" != a)
      if (this.get("pano")) {
        ...
        a &&
          b &&
          ((a = _.mta(a, b, this.get("pano"), this.h)), this.set("url", a));
      } else {
        a = {};
        if ((b = this.get("center")))
          (b = new _.me(b.lat(), b.lng())), (a.ll = b.toUrlValue());
        b = this.get("zoom");
        _.Od(b) && (a.z = b);
  ...
  _.n.qh = function () {
    Uva(this) &&
      ...
      _.O(this.C, 148263),
      (this.j.style.display = ""),
      (this.h.textContent = "Report a map error"));
  };
  _.n.Sb = function () {
  ...
  dwa.prototype.update = function (a) {
    ...
    if (a < this.fa.offsetWidth)
      ...
      for (d = this.Pl.length - 1; 0 <= d; d--)
        (c = this.Pl[d]), c.qh(), (b = this.fa.offsetWidth), a < b && c.rh();
    _.M(this.fa, "resize");
  };
  var cH = {},
    kxa = (cH[1] = {});
  ...
  dH.prototype.changed = function (a) {
    if ("zoom" === a || "zoomRange" === a) {
      ...
      "number" === typeof a &&
        b &&
        ((this.D.disabled = a >= b.max),
        (this.D.style.cursor = a >= b.max ? "default" : "pointer"),
        (this.F.disabled = a <= b.min),
        (this.F.style.cursor = a <= b.min ? "default" : "pointer"));
    }
  };
  _.B(eH, _.N);
  ...
  _.n.mapTypeId_changed = function () {
    "streetview" === this.get("mapTypeId") &&
      (HG(this.D), (this.m.style.color = "#fff"));
  };
  _.n.rh = function () {
    this.get("hidden") ||
  ...
  hH.prototype.visible_changed = function () {
    this.get("visible")
      ? (_.cz(), this.m.appendChild(this.h.element), this.h.show())
      : this.h.Sb();
  };
  ...
  _.n.mapTypeId_changed = function () {
    "streetview" == this.get("mapTypeId") &&
      (HG(this.h), (this.m.style.color = "#fff"));
  };
  _.n.fontLoaded_changed = function () {
    _.M(this.h, "resize");
  };
    ...
    if ("sessionState" != a) {
      ...
      if ((null != b && null != c) || null != d) {
        ...
        "hybrid" == f || "satellite" == f
          ? _.D(e.o, 1, 3)
          : (_.D(e.o, 1, 0),
            "terrain" == f && ((f = _.K(a.o, 5, _.UB)), _.Wc(f.o, 1, 4)));
        f = _.K(e.o, 2, _.bC);
        _.D(f.o, 1, 2);
        c && ((g = c.lng()), _.D(f.o, 2, g), (c = c.lat()), _.D(f.o, 3, c));
        "number" === typeof b && _.D(f.o, 6, b);
  ...
  var mxa = [
    ...
    pwa = [
      _.Mq["lilypad_pegman_0.svg"],
      _.Mq["lilypad_pegman_1.svg"],
      _.Mq["lilypad_pegman_2.svg"],
      _.Mq["lilypad_pegman_3.svg"],
      _.Mq["lilypad_pegman_4.svg"],
      _.Mq["lilypad_pegman_5.svg"],
      _.Mq["lilypad_pegman_6.svg"],
      _.Mq["lilypad_pegman_7.svg"],
      _.Mq["lilypad_pegman_8.svg"],
      _.Mq["lilypad_pegman_9.svg"],
      _.Mq["lilypad_pegman_10.svg"],
      _.Mq["lilypad_pegman_11.svg"],
      _.Mq["lilypad_pegman_12.svg"],
      _.Mq["lilypad_pegman_13.svg"],
      _.Mq["lilypad_pegman_14.svg"],
      _.Mq["lilypad_pegman_15.svg"],
    ];
  _.B(nH, _.N);
  _.n = nH.prototype;
  ...
  _.n.takeDownUrl_changed = function () {
    ...
    a &&
      ...
      (b = c
        ? c + ("&cbp=" + a + "&hl=" + _.nd(_.ud(_.dg)))
        : this.h.getUrl("report", [
            "panoid=" + b,
            "cbp=" + a,
            "hl=" + _.nd(_.ud(_.dg)),
          ])),
      _.Km(this.anchor, _.Rx(b)),
      this.set("rmiLinkData", {
  ...
  _.n.keyboardShortcuts_changed = function () {
    ...
    a
      ? ((this.ha.fa.style.display = ""),
        this.D.set("keyboardShortcutsShown", !0))
      : a ||
        ((this.ha.fa.style.display = "none"),
        this.D.set("keyboardShortcutsShown", !1));
  };
  ...
  _.n.panoramaVisible_changed = function () {
    ...
    a &&
      (this.J && a.__gm.bindTo("sloTrackingId", this.J),
  ...
  wH.prototype.mf = function (a) {
    ...
    for (
      var b = _.A(_.v(this.h, "values").call(this.h)), c = b.next();
      !c.done;
      c = b.next()
    ) {
      c = c.value;
  ...
  var oxa = [37, 38, 39, 40],
    pxa = [38, 40],
    qxa = [37, 39],
    rxa = { 38: [0, -1], 40: [0, 1], 37: [-1, 0], 39: [1, 0] },
    sxa = { 38: [0, 1], 40: [0, -1], 37: [-1, 0], 39: [1, 0] };
  ...
  _.n.tx = function (a) {
    ...
    switch (a.keyCode) {
      ...
      case 39:
        ...
        (b && this.N && !this.j) || c
          ? ((this.G[a.keyCode] = !0),
            this.m || ((this.H = 0), (this.h = 1), this.Tr()),
            DH(b ? 165376 : 165375, b ? "Tmki" : "Rmki"))
          : this.m ||
            ((this.D[a.keyCode] = 1),
            this.j || ((this.C = new _.UE(100)), this.Sr()),
            DH(165373, "Pmki"));
        b = !0;
        break;
      case 34:
  ...
  _.n.Sr = function () {
    for (
      var a = 0, b = 0, c = !1, d = _.A(oxa), e = d.next();
      !e.done;
      e = d.next()
    )
      (e = e.value),
    ...
    c
      ? ((c = 1),
        _.VE(this.C) && (c = this.C.next()),
        (d = Math.round(35 * c * a)),
        (c = Math.round(35 * c * b)),
        0 === d && (d = a),
        0 === c && (c = b),
        _.M(this, "panbynow", d, c, 1),
        (this.j = _.Gy(this, this.Sr, 10)))
      : (this.j = 0);
  };
  _.n.Tr = function () {
    for (var a = 0, b = 0, c = !1, d = 0; d < GH.length; d++)
      this.G[GH[d]] && ((c = sxa[GH[d]]), (a += c[0]), (b += c[1]), (c = !0));
    c
      ? (_.M(this, "tiltrotatebynow", this.h * a, this.h * b),
        (this.m = _.Gy(this, this.Tr, 10)),
        (this.h = Math.min(1.8, this.h + 0.01)),
        this.H++,
        (this.J = { x: a, y: b }))
      : ((this.m = 0),
        (this.F = new _.UE(Math.min(Math.round(this.H / 2), 35), 1)),
