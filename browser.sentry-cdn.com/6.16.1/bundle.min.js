...
var Sentry = (function (t) {
  ...
  function O(t, n) {
    try {
      for (
        var r = t, i = [], e = 0, o = 0, u = " > ".length, s = void 0;
        r &&
        e++ < 5 &&
        !(
          "html" === (s = D(r, n)) ||
          (e > 1 && o + i.length * u + s.length >= 80)
        );
  ...
  function D(t, n) {
    ...
    var h = (null === (r = n) || void 0 === r ? void 0 : r.length)
      ? n
          .filter(function (t) {
      ...
      return (
        ...
        (t.prototype.t = function (t) {
          ...
          var r = v(n.slice(1), 6),
            ...
            l = h.split("/");
          if (
            (l.length > 1 && ((f = l.slice(0, -1).join("/")), (h = l.pop())), h)
          ) {
            var d = h.match(/^\d+/);
            d && (h = d[0]);
          }
  ...
  function z(t, n, r, i) {
    if ((void 0 === r && (r = 1 / 0), void 0 === i && (i = new U()), 0 === r))
      return (function (t) {
        ...
        case "console":
          !(function () {
            ...
            ["debug", "info", "warn", "error", "log", "assert"].forEach(
              function (t) {
                t in it.console &&
                  B(it.console, t, function (n) {
                    return function () {
                      for (var r = [], i = 0; i < arguments.length; i++)
                        r[i] = arguments[i];
                      at("console", { args: r, level: t }),
            ...
            it.document.addEventListener("click", n, !1),
              ...
              ["EventTarget", "Node"].forEach(function (n) {
                ...
                r &&
                  ...
                  (B(r, "addEventListener", function (n) {
              ...
              return function () {
                ...
                return (
                  ...
                  "function" == typeof o.onreadystatechange
                    ? B(o, "onreadystatechange", function (t) {
                        return function () {
                  ...
                  t.apply(it, n).then(
                    function (t) {
                      return (
                        at(
                          "fetch",
                          f(f({}, i), { endTimestamp: Date.now(), response: t })
                        ),
                        t
                      );
                    },
                    function (t) {
                      throw (
                        (at(
                          "fetch",
                          f(f({}, i), { endTimestamp: Date.now(), error: t })
                        ),
                        t)
                      );
                    }
          ...
          !(function () {
            ...
            (it.onpopstate = function () {
              ...
              var r = it.location.href,
                i = rt;
              if (((rt = r), at("history", { from: i, to: r }), e))
                try {
                  return e.apply(this, t);
                } catch (t) {}
            }),
              B(it.history, "pushState", o),
              B(it.history, "replaceState", o);
          })();
          break;
        case "error":
          (pt = it.onerror),
            (it.onerror = function (t, n, r, i, e) {
              return (
                at("error", { column: i, error: e, line: r, msg: t, url: n }),
                !!pt && pt.apply(this, arguments)
              );
            });
          break;
        case "unhandledrejection":
          (yt = it.onunhandledrejection),
            (it.onunhandledrejection = function (t) {
              return (
                at("unhandledrejection", t), !yt || yt.apply(this, arguments)
              );
            });
          break;
        default:
  ...
  function ct(t) {
    return (
      void 0 === t && (t = []),
      "Request" in it && S(t[0], Request) && t[0].method
    ...
    return (
      ...
      function (r) {
        if (
          ...
          void 0 === ht
            ? (t({ event: r, name: i, global: n }), (vt = r))
            : (function (t, n) {
                if (!t) return !0;
                ...
                return !1;
              })(vt, r) && (t({ event: r, name: i, global: n }), (vt = r)),
            clearTimeout(ht),
            (ht = it.setTimeout(function () {
              ht = void 0;
            }, lt));
        }
      }
  ...
  function Et(t, n) {
    ...
    if (t.exception && t.exception.values) {
      var i = t.exception.values[0],
        e = i.mechanism;
      if (
        ((i.mechanism = f(f(f({}, { type: "generic", handled: !0 }), e), n)),
        n && "data" in n)
      ) {
        var o = f(
          f({}, null === (r = e) || void 0 === r ? void 0 : r.data),
          n.data
        );
        i.mechanism.data = o;
      }
  ...
  function jt(t) {
    var n;
    if (null === (n = t) || void 0 === n ? void 0 : n.__sentry_captured__)
      return !0;
    try {
  ...
  var _t = (function () {
      function t(t) {
        ...
        (this.l = "PENDING"),
          ...
          (this.g = function (t, r) {
            "PENDING" === n.l &&
              (k(r) ? r.then(n.m, n.j) : ((n.l = t), (n._ = r), n.k()));
          }),
          (this.S = function (t) {
            ...
            if ("PENDING" !== n.l) {
              ...
              (n.p = []),
                t.forEach(function (t) {
                  t.done ||
                    ("RESOLVED" === n.l && t.onfulfilled && t.onfulfilled(n._),
                    "REJECTED" === n.l && t.onrejected && t.onrejected(n._),
                    (t.done = !0));
                });
            }
          });
    ...
    kt = (function () {
      ...
      return (
        ...
        (t.prototype.add = function (t) {
          ...
          if (!this.isReady())
            return _t.reject(
              new N("Not adding Promise due to buffer limit reached.")
            );
          var r = t();
          return (
            -1 === this.D.indexOf(r) && this.D.push(r),
            r
              .then(function () {
                return n.remove(r);
              })
            ...
            return (
              n instanceof t
                ? ((this.M = f(f({}, this.M), n.M)),
                  (this.A = f(f({}, this.A), n.A)),
                  (this.q = f(f({}, this.q), n.q)),
                ...
                : x(n) &&
                  ((n = n),
                  (this.M = f(f({}, this.M), n.tags)),
                  (this.A = f(f({}, this.A), n.extra)),
                  (this.q = f(f({}, this.q), n.contexts)),
          ...
          (t.prototype.applyToEvent = function (t, n) {
            ...
            if (
              (this.A &&
                ...
                (t.extra = f(f({}, this.A), t.extra)),
              this.M &&
                Object.keys(this.M).length &&
                (t.tags = f(f({}, this.M), t.tags)),
              this.C &&
                Object.keys(this.C).length &&
                (t.user = f(f({}, this.C), t.user)),
              this.q &&
                Object.keys(this.q).length &&
                (t.contexts = f(f({}, this.q), t.contexts)),
            ...
            return (
              this.B(t),
              (t.breadcrumbs = l(t.breadcrumbs || [], this.I)),
              (t.breadcrumbs =
                t.breadcrumbs.length > 0 ? t.breadcrumbs : void 0),
              this.W(l(It(), this.R), t, n)
            );
          }),
    ...
    qt = (function () {
      ...
      return (
        ...
        (t.prototype.captureMessage = function (t, n, r) {
          ...
          return (
            this.V("captureMessage", t, n, f(f({}, e), { event_id: i })), i
          );
        }),
        (t.prototype.captureEvent = function (t, n) {
          var r = mt();
          return (
            "transaction" !== t.type && (this.K = r),
            this.V("captureEvent", t, f(f({}, n), { event_id: r })),
            r
          );
        }),
        ...
        (t.prototype.startSession = function (t) {
          var n = this.getStackTop(),
            ...
            c = new Mt(
              f(
                f(
                  f({ release: u, environment: s }, r && { user: r.getUser() }),
                  a && { userAgent: a }
                ),
                t
              )
  ...
  function Ht() {
    var t = Lt();
    return (
      (Pt(t) && !Ft(t).isOlderThan(At)) || Jt(t, new qt()),
      d()
        ? (function (t) {
            var n, r, i;
            try {
  ...
  function Kt(t) {
    ...
    return (
      (function (t) {
        ...
        return (
          -1 !== e.indexOf("Debug") &&
            i.push.apply(i, l(i.splice(e.indexOf("Debug"), 1))),
          i
        );
      })(t).forEach(function (t) {
        (n[t.name] = t),
      ...
      return (
        ...
        (t.prototype.captureMessage = function (t, n, r, i) {
          var e = this,
            o = r && r.event_id,
            u = E(t)
              ? this.ht().eventFromMessage(String(t), n, r)
              : this.ht().eventFromException(t, r);
          return (
            this.ft(
              u
                .then(function (t) {
        ...
        (t.prototype.captureEvent = function (t, n, r) {
          ...
          if (
            !(
              (null === (i = n) || void 0 === i
                ? void 0
                : i.originalException) && jt(n.originalException)
            )
          ) {
            var e = n && n.event_id;
            return (
              this.ft(
                this.vt(t, n, r).then(function (t) {
                  e = t;
                })
              ),
              e
        ...
        (t.prototype.wt = function (t) {
          ...
          "environment" in t ||
            ...
            t.message && (t.message = F(t.message, u));
        ...
        (t.prototype._t = function (t, n, r) {
          var i,
            ...
            f = this.getTransport();
          if (!this.lt())
            return _t.reject(new N("SDK not enabled, will not capture event."));
          var h = "transaction" === t.type;
          return !h && "number" == typeof a && Math.random() > a
            ? (null === (e = (i = f).recordLostEvent) ||
                void 0 === e ||
                e.call(i, c.SampleRate, "event"),
              _t.reject(
                new N(
                ...
                .then(function (r) {
                  ...
                  if (null === r)
                    throw (
                      (null === (e = (i = f).recordLostEvent) ||
                        void 0 === e ||
                        e.call(i, c.EventProcessor, t.type || "event"),
                      new N(
                        "An event processor returned null, will not send event."
                      ))
                    );
                  if ((n && n.data && !0 === n.data.__sentry__) || h || !s)
                    return r;
                  var u = s(r, n);
                  return o.kt(u);
                })
                .then(function (n) {
                  ...
                  if (null === n)
                    throw (
                      (null === (e = (i = f).recordLostEvent) ||
                        void 0 === e ||
                        e.call(i, c.BeforeSend, t.type || "event"),
                      new N(
    ...
    Yt = (function () {
      ...
      return (
        ...
        (t.prototype.sendSession = function (t) {
          this.St.sendSession
            ? this.St.sendSession(t).then(null, function (t) {
          ...
          Ct(function (n) {
            ...
            if (i) {
              var e = r.getClient(),
                o = e ? e.getOptions() : {},
                u =
                  "function" == typeof i._mergeOptions
                    ? i._mergeOptions(o)
                    : {};
        ...
        (t.prototype.At = function (t) {
          ...
          for (var i = t.length - 1; i >= 0; i--) {
            ...
            if (
              ...
              "[native code]" !==
                (null === (r = e) || void 0 === r ? void 0 : r.filename)
            )
        ...
        (n = (function (t) {
          ...
          for (
            ...
            if ((e = hn.exec(s[a]))) {
              ...
              e[3] && e[3].indexOf(" > eval") > -1 && (i = dn.exec(e[3]))
                ? ((e[1] = e[1] || "eval"),
                  (e[3] = i[1]),
                  (e[4] = i[2]),
                  (e[5] = ""))
  ...
  function Sn(n, r, i, e) {
    ...
    return (
      (o.level = i), e && e.event_id && (o.event_id = e.event_id), _t.resolve(o)
    );
  }
  function On(t, n, r) {
    var i, e;
    if ((void 0 === r && (r = {}), b(t) && t.error))
      return (i = jn(mn((t = t.error))));
    if (
      w(t) ||
      ...
      return (
        "code" in o &&
          (i.tags = f(f({}, i.tags), { "DOMException.code": "" + o.code })),
        i
      );
    }
    return m(t)
      ...
      ? (Et(
        ...
        i)
      : (gt((i = Dn(t, n, r)), "" + t, void 0), Et(i, { synthetic: !0 }), i);
  }
  function Dn(t, n, r) {
    void 0 === r && (r = {});
    var i = { message: t };
  ...
  function Rn() {
    ...
    if (
      "function" ==
      typeof (null === (t = r) || void 0 === t ? void 0 : t.createElement)
    )
      try {
  ...
  function In(t, n) {
    if (
      ...
      return Nn.navigator.sendBeacon.bind(Nn.navigator)(t, n);
    if (Z()) {
      var r = Rn();
      r(t, {
        body: n,
    ...
    An = (function () {
      function n(t) {
        ...
        (this.options = t),
          ...
          (this.qt = {}),
          (this.Lt = {}),
          (this.Ut = new Wt(t.dsn, t.Ht, t.tunnel)),
          (this.url = this.Ut.getStoreEndpointWithUrlEncodedAuth()),
      ...
      return (
        ...
        (n.prototype.recordLostEvent = function (t, n) {
          ...
          if (this.options.sendClientReports) {
            var i = Cn[n] + ":" + t;
            L.log("Adding outcome: " + i),
              (this.Lt[i] = (null != (r = this.Lt[i]) ? r : 0) + 1);
          }
        }),
        ...
        (n.prototype.Ft = function (n) {
          ...
          this.Jt(e) &&
            L.warn(
              "Too many " + r + " requests, backing off until: " + this.Xt(r)
            ),
            s !== t.Status.Success ? u(i) : o({ status: s });
        }),
          ...
          if (u) {
            try {
              for (
                ...
                try {
                  for (
                    var d = ((i = void 0), h(f[1].split(";"))), p = d.next();
                    !p.done;
                    p = d.next()
                  ) {
                    var y = p.value;
        ...
        (n.prototype.$t = function (t, n) {
          ...
          return (
            ...
            this.D.add(function () {
              ...
              throw (
                (n instanceof N
                  ? r.recordLostEvent(c.QueueOverflow, t.type)
                  : r.recordLostEvent(c.NetworkError, t.type),
                n)
              );
            })
          );
        ...
        throw (
          ...
          Bt(function (r) {
            r.addEventProcessor(function (t) {
              var r = f({}, t);
              return (
                n.mechanism && (gt(r, void 0, void 0), Et(r, n.mechanism)),
                (r.extra = f(f({}, r.extra), { arguments: i })),
                r
              );
            }),
              captureException(t);
    ...
    if ((void 0 === t && (t = {}), Pn.document))
      if (t.eventId)
        if (t.dsn) {
          ...
          (n.async = !0),
            (n.src = new Wt(t.dsn).getReportDialogEndpoint(t)),
  ...
  var Wn = (function () {
      function n(t) {
        (this.name = n.id),
          (this.Gt = !1),
          (this.Kt = !1),
          (this.at = f({ onerror: !0, onunhandledrejection: !0 }, t));
      }
      return (
        (n.prototype.setupOnce = function () {
          (Error.stackTraceLimit = 50),
            this.at.onerror &&
              (L.log("Global Handler attached: onerror"), this.zt()),
            this.at.onunhandledrejection &&
              (L.log("Global Handler attached: onunhandledrejection"),
              this.Vt());
        }),
              ...
              callback: function (r) {
                ...
                if (o && !Jn() && !u) {
                  var s = e.getClient(),
                    a =
                      void 0 === i && g(r.msg)
                        ? t.Qt(r.msg, r.url, r.line, r.column)
                        : t.Yt(
                            On(i || r.msg, void 0, {
                              attachStacktrace:
                  ...
                  Et(a, { handled: !1, type: "onerror" }),
                    e.captureEvent(a, { originalException: i });
                }
              },
              type: "error",
            }),
    ...
    Gn = (function () {
      ...
      return (
        (t.prototype.setupOnce = function () {
          var t = y();
          (this.at.setTimeout && B(t, "setTimeout", this.tn.bind(this)),
          this.at.setInterval && B(t, "setInterval", this.tn.bind(this)),
          this.at.requestAnimationFrame &&
            B(t, "requestAnimationFrame", this.nn.bind(this)),
          this.at.XMLHttpRequest &&
            "XMLHttpRequest" in t &&
            B(XMLHttpRequest.prototype, "send", this.rn.bind(this)),
          this.at.eventTarget) &&
        ...
        (t.prototype.nn = function (t) {
          return function (n) {
            return t.call(
              ...
              Xn(n, {
                mechanism: {
                  data: { function: "requestAnimationFrame", handler: P(t) },
                  handled: !0,
                  type: "instrument",
                },
              })
                    ...
                    B(i, t, function (n) {
                      ...
                      return (
                        n.__sentry_original__ &&
                          (r.mechanism.data.handler = P(n.__sentry_original__)),
                        Xn(n, r)
                      );
                    });
                }
    ...
    Kn = (function () {
      ...
      return (
        ...
        (n.prototype.en = function (n) {
          ...
          Ht().addBreadcrumb(r, { input: n.args, level: n.level });
        }),
      ...
      function n(n) {
        ...
        return (
          ...
          (n.Ht.sdk = n.Ht.sdk || {
            ...
            packages: [{ name: "npm:@sentry/browser", version: on }],
            version: on,
          }),
      ...
      return (
        ...
        (n.prototype.showReportDialog = function (t) {
          void 0 === t && (t = {}),
            y().document &&
              (this.lt()
                ? Bn(f(f({}, t), { dsn: t.dsn || this.getDsn() }))
                : L.error(
        ...
        (n.prototype.bt = function (n, r, i) {
          return (
            ...
            t.prototype.bt.call(this, n, r, i)
          );
        }),
  ...
  return (
    ...
    (t.close = function (t) {
      ...
      return n
        ? n.close(t)
        : (L.warn("Cannot flush events and disable SDK. No client defined."),
          _t.resolve(!1));
    }),
    (t.configureScope = function (t) {
      Xt("configureScope", t);
    }),
    (t.defaultIntegrations = ir),
    (t.eventFromException = kn),
    (t.eventFromMessage = Sn),
    (t.flush = function (t) {
      var n = Ht().getClient();
      return n
        ? n.flush(t)
        : (L.warn("Cannot flush events. No client defined."), _t.resolve(!1));
    }),
    ...
    (t.init = function (t) {
      if (
        (void 0 === t && (t = {}),
        void 0 === t.defaultIntegrations && (t.defaultIntegrations = ir),
        void 0 === t.release)
      ) {
        var n = y();
        n.SENTRY_RELEASE &&
