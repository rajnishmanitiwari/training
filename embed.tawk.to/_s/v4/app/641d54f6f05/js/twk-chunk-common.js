            ...
            (function (t, e, n) {
              ...
              },
              {
                ...
                value: function (t) {
                  if (t)
                    return (
                      (t = (t = t.replace(i.a.regLineBreaks, i.a.br)).replace(
                        i.a.regTelMatch,
                        this.parsePhoneNumber.bind(this)
                      )),
    ...
    5868: function (t, e, n) {
      ...
      var i = [
        ...
        o = {
          ...
          regTelMatch:
            /(tel:\+|\+|tel:){1}(?:[0-9\-\(\)\/\.]\s?){6,15}[0-9]{1}\b/gm,
          br: "<br/>",
              ...
              },
              {
                ...
                value: function (e, n, i, o) {
                  if (
                    ...
                    t.Tawk_Window.jsApi.store.getters["widget/isIframe"]
                  )
              ...
              for (
                ...
                if (
                  ...
                  for (
                    ...
                    (v = d - h),
                      (m = 36 - h),
                      y.push(c(this.digitToBasic(h + (v % m), 0))),
                      (d = s(v / m));
          ...
          return (
            (function (t, e, n) {
              ...
              },
              {
                ...
                value: function () {
                  var e =
                    t.Tawk_Window.webStorage.cookieStore.getItem("twk_idm_key");
                  return (
                    e && e.length
                      ? (e = e[0])
                      : ((e = Object(o.a)()),
            ...
            actions: {
              ...
              setPreviousMessages: function (e) {
                var n,
                  ...
                  f = s.chat.history,
                  h = 0;
                for (s.chat.endVersion = 0, n = 0, i = f.length; n < i; n++)
                  "CHAT_ENDED" === f[n].m &&
                    (l("processEndedChat", f.slice(h, n + 1)),
                    (d = n + 1),
                    (s.chat.endVersion += 1),
                    (h = n));
                for (
