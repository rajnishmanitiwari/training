              ...
              loaded: function () {
                if ("text" === this.bubble.type) {
                  var e,
                    ...
                    u,
                    f,
                    g = this.$refs["tawk-canvas-bubble"];
                  ...
                  k.clearRect(0, 0, 134, 63),
                    ...
                    this.isCenter || this.isBottom
                      ? ((e = p = 6),
                        ...
                        (o = 79),
                        (n = !0),
                        (a = { s1: 0.9, a1: 0.1, s2: 0.4, a2: 1.15 }))
                      : ((e = 68),
                        (i = (p = 16) + 3),
                        (s = 81),
                        (o = 6),
                        (n = !1),
                        (a = { s1: 1.1, a1: 1.9, s2: 1.6, a2: 0.85 })),
                    this.isRTL
                      ? ((b = (r = 10) + 2),
                        (l = r + 5),
                        (h = r - 2),
                        ...
                        (f = !n),
                        this.isBottom || this.isCenter
                          ? ((f = !n), (a.s2 = 0.6), (a.a2 = 1.85))
                          : ((f = n), (a.s2 = 0.2), (a.a2 = 1.45)))
                      : ((b = (r = 2) + d - 2),
                        (l = r + d - 5),
                        (h = r + d + 2),
                        (c = r + d + 2),
                    ...
                    k.lineTo(68, p),
                    k.lineTo(r + d - 8, p),
                    k.quadraticCurveTo(r + d, p, r + d, p + 8),
                    k.lineTo(r + d, p + m - 8),
                    k.quadraticCurveTo(r + d, p + m, r + d - 8, p + m),
                    k.lineTo(r + 8, p + m),
                    k.quadraticCurveTo(r, p + m, r, p + m - 8),
                    k.lineTo(r, p + 8),
                    k.quadraticCurveTo(r, p, r + 8, p),
                    (k.strokeStyle = y),
                    (k.lineWidth = 2),
                    k.stroke(),
                    k.closePath(),
                    k.fill(),
                    k.beginPath(),
                    k.arc(68, i, 10, Math.PI * a.s1, Math.PI * a.a1, n),
                    (k.strokeStyle = y),
                    (k.lineWidth = 2),
                    k.stroke(),
                    k.fill(),
                    ...
                    k.fill(),
                    k.beginPath(),
                    k.arc(b, e + 5, 10, Math.PI * a.s2, Math.PI * a.a2, f),
                    (k.strokeStyle = y),
                    (k.lineWidth = 2),
                    k.stroke(),
                    k.closePath(),
                    ...
                    k.closePath(),
                    (k.lineWidth = 2),
                    (k.strokeStyle = this.bubble.config.foreground),
                    k.stroke(),
                    k.beginPath(),
                    k.moveTo(c, e + 1.5),
                    k.lineTo(u, e + 8),
                ...
                t.Tawk_Window.eventBus.$on(
                  "mpIsVisible",
                  this.updateMessagPreviewData
                );
              },
              beforeDestroy: function () {
                t.Tawk_Window.eventBus.$off(
                  "mpIsVisible",
                  this.updateMessagPreviewData
                );
              },
