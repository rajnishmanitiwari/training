  ...
  ["chunk-vendors"],
  {
    ...
    "6fc0": function (t, e, n) {
      ...
      (r = function () {
          ...
          var i = function (o) {
            return e(this, void 0, void 0, function () {
              return n(this, function (e) {
                switch (e.label) {
                  case 0:
                    return o.storageArea !== localStorage || o.key !== t
                      ? [3, 2]
                      : [4, r()];
                  case 1:
                    e.sent() && window.removeEventListener("storage", i),
                      (e.label = 2);
                  case 2:
                    return [2];
                }
        ...
        var c,
          u = { EXCLUSIVE: "exclusive", SHARED: "shared" };
        function h() {
          return (
        ...
        var f = (function () {
          ...
          return (
            (f.prototype._init = function () {
              ...
              var e = new i({ key: this._clientId });
              e.start(),
                e.detect(function () {
                        ...
                        return e(this, void 0, void 0, function () {
                          ...
                          return n(this, function (n) {
                            ...
                            if (
                              ...
                              (f = r._resolveWithCB(a, o, i)),
                              (d = r._heldLockSet()),
                              (p = d.find(function (t) {
                                return t.name === c.name;
                              })),
                              (_ = r._requestLockQueueMap()[c.name] || []),
                              !0 === s.steal)
                            ) {
                              if (!r._handleExceptionWhenStealIsTrue(s, i))
                                return [2];
                              ...
                              if (!0 === s.ifAvailable)
                                return (p &&
                                  ...
                                  _.length
                                  ? [2, f(null)]
                                  : [2, r._handleNewHeldLock(c, f)];
                              if (
                                void 0 !== s.signal &&
                                !r._handleSignalExisted(s, i, c)
                              )
                                return [2];
                            }
                            return (
                              r._handleHeldLockAndRequest(p, c, f, _, d), [2]
                            );
                          });
                        });
                      }),
            ...
            (f.prototype._handleRequestArgs = function (e, n) {
              ...
              return Object.values(u).indexOf(o.mode) < 0
                ? (n(
                    new TypeError(
                  ...
                  return (
                    ...
                    (a = function () {
                      return !(
                        ...
                        (s._handleHeldLockBeSteal(t), (i = !0), 0)
                      );
                    }),
                    l(c.HELD_LOCK_SET, a),
                    r({ name: t.name, mode: t.mode }).then(function () {
              ...
              l(c.HELD_LOCK_SET, function () {
                return e(o, void 0, void 0, function () {
                  return n(this, function (e) {
                    switch (e.label) {
                      case 0:
                        return i || !this._isInHeldLockSet(t.uuid)
                          ? [3, 5]
                          : ((i = !0), [4, r({ name: t.name, mode: t.mode })]);
                      case 1:
                        return (
                          e.sent(),
            ...
            (f.prototype._storeHeldLockSetAndRequestLockQueueMap = function (
              t,
              e
            ) {
