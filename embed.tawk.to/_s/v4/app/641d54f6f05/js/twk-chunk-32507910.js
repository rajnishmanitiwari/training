                      ...
                      [
                        "logo" === e.type
                          ? a(
                              ...
                              {
                                class: [
                                  "header-card card--" + e.type,
                                  e.content.alignment &&
                                    "card--alignment-" + e.content.alignment,
                                ],
                              },
                              [
                                a("tawk-image", {
                                  attrs: {
                                    src:
                                      t.logoUrl + "/" + e.content.image.content,
                          ...
                          : t._e(),
                        "heading" === e.type
                          ? a("div", { class: "header-card card--" + e.type }, [
                              a(
                                "p",
                                {
                                  staticClass:
                        ...
                        "agents" === e.type
                          ? a(
                              ...
                              {
                                class: [
                                  "tawk-flex card--" + e.type,
                                  e.content.alignment &&
                                    "card--flex-" + e.content.alignment,
                                ],
                              },
                              [
                                a("agent-card", {
                                  attrs: { agentIds: e.content.agentIds },
                                }),
                              ],
                              1
                            )
                ...
                a(
                  ...
                  [
                    ...
                    t.isHamburgerMenuVisible && !t.needConsent
                      ...
                      : t._e(),
                    t.isWindowed || (t.isRoundWidget && !t.mobileBrowserName)
                      ? t._e()
                      : a(
                          "tawk-button",
                          {
              ...
              styleObject: function () {
                ...
                return (
                  this.isWindowed || this.isEmbedded
                    ? (e["position:"] = "absolute !important;")
                    : (e["position:"] = "fixed !important;"),
                  this.isWindowed || this.mobileBrowserName || this.isEmbedded
                    ? ((e["bottom:"] = "0px !important;"),
                      (e["right:"] = "0px !important;"),
                      (e["left:"] = "0px !important;"),
                      (e["top:"] = "0px !important;"))
                    : ((t =
                        this.isCenter && this.isRoundWidget
                          ...
                          : this.xOffset - 10),
                      this.isRight
                        ? (e["right:"] = "".concat(t, "px !important;"))
                        : (e["left:"] = "".concat(t, "px !important;")),
                      this.isRoundWidget
                        ? this.isBottom
                          ? (e["bottom:"] = "".concat(
              ...
              openView: function () {
                if (((this.initialized = !0), this.mobileBrowserName)) {
                  ...
                  t.Tawk_Window.isMobileOptimizedWebsite ||
                    ...
                    "" !== this.noZoomMetaTag.content
                      ? t.Tawk_Window.metaContent &&
                        ...
                        e.setAttribute(
                          "content",
                          t.Tawk_Window.metaContent + ", user-scalable=no"
                        )
                      : ((this.noZoomMetaTag.content =
                  ...
                  for (
                    ...
                    a.style.setProperty(s[i], "100%", "important");
                ...
                if (
                  ...
                  this.isBottom
                    ? ((a = "transform:translate(0, 30px);"),
                      (s = "transform:translate(0, 0px);"))
                    : this.isCenter
                    ? this.isRight
                      ? ((a = "transform:translate(30px,0);"),
                        (s = "transform:translate(0px,0);"))
                      : ((a = "transform:translate(-30px,0);"),
                        (s = "transform:translate(0px,0);"))
                    : ((a = "transform:translate(0, -30px);"),
                      (s = "transform:translate(0, 0px);"));
                  var c,
                    l = "{0%{opacity:0;" + a + ";}to{opacity:1;" + s + "}}";
                  (i += "@keyframes " + r + l),
                    (i += "@-moz-keyframes " + r + l),
                    (i += "@-webkit-keyframes " + r + l),
                    (i +=
                      "#" +
                      o +
                      ".open{animation : " +
                  ...
                  (d.type = "text/css"),
                    ...
                    h.appendChild(u),
                    d.styleSheet
                      ? (d.styleSheet.cssText = m.nodeValue)
                      : d.appendChild(m);
                }
                t.Tawk_Window.activityMonitor.setupMaxWidgetListeners();
              },
                    ...
                    return 0 === s
                      ...
                      : (s < 250 && (s = 250),
                        0 === s
                          ...
                          : void (
                              (s += e + a) &&
                              t.maxDimension.height > s + 10 &&
                              (t.resizeHeightTo = s + 10)
                            ));
                  }, 300);
              },
    ...
    "702b": function (t, e, a) {
      ...
      (function (t) {
        ...
        e.a = {
          ...
          methods: h(
            h({}, Object(s.b)({ routerPush: "router/routerPush" })),
            {},
            {
              homeLoaded: function () {
                var t = this;
                  ...
                  ? a(
                      ...
                      [
                        a(
                          ...
                          [
                            a("tawk-icon", { attrs: { type: "mobile-send" } }),
                            t._v(
                  ...
                  ? a(
                      ...
                      [
                        a(
                          ...
                          [
                            a("tawk-icon", { attrs: { type: "message" } }),
                            t._v(
                              " " +
                ...
                t.isDraggedOver
                  ? a(
                      ...
                      [
                        ...
                        a("p", [t._v(t._s(t.$i18n("rollover", "uploadFile")))]),
                      ],
                      1
                    )
                  : t._e(),
              ...
              submitForm: function (e) {
                ...
                e.hasError ||
                  ...
                  t.Tawk_Window.app.$socket.publish(
                    ...
                    function (s) {
                      var i = "";
                      if (((a.isSubmitting = !1), s))
                        return "InvalidArgument" === s.code &&
                          "email" === s.message
                          ? (a.$store.commit(
                              "session/setIsNotValidEmail",
                              "email"
                            ),
                            void a.$emit("update:isSubmitting", !1))
                          : void (a.submissionError = !0);
                      a.$store.commit("session/setPrechatSubmitted", !0),
                        t.Tawk_Window.jsApi.triggerApiHandlers(
                          "onPrechatSubmit",
                          e.formData.questions
                        ),
                        a.$nextTick(function () {
                          if (
                            e.formData.questions &&
                            e.formData.questions.length > 0
                          )
                            for (
                              var s = 0, r = e.formData.questions.length;
                              s < r;
                              s++
                            )
                              (i += ""
                                .concat(e.formData.questions[s].label, " : ")
                                .concat(e.formData.questions[s].answer)),
                                s !== r - 1 && (i += "\r\n");
                          i && t.Tawk_Window.chatManager.sendMessageToServer(i),
                            a.routerPush("chat"),
                      ...
                      function (s) {
                        ...
                        a.routerPush("offline-success"),
                          ...
                          a.$store.dispatch(
                            ...
                            { n: e.formData.name, e: e.formData.email }
                          ),
                          t.Tawk_Window.jsApi.triggerApiHandlers(
                            "onOfflineSubmit",
                            e.formData
          ...
          mounted: function () {
            ...
            this.processChatMessages(),
              this.showAgentTyping &&
                (t.Tawk_Window.eventBus.$on("agentIsTyping", function (t) {
              ...
              t.Tawk_Window.eventBus.$on("callDataUpdated", function (t) {
                for (
                  var a = e.isScrollBarBottom(), s = 0;
                  s < e.messageBlocks.length;
                  s++
                ) {
            ...
            {},
            {
              ...
              scrollToEl: function (t) {
                if (t) {
                  ...
                  a &&
                    a.length &&
                    s &&
                    (void 0 !== a[0].offsetTop
                      ? (s.scrollTop = a[0].offsetTop - 40)
              ...
              processChatMessages: function () {
                ...
                for (var a in (this.clearMessageBlock(), this.chatMessages)) {
                  ...
                  !e &&
                  s.messageId === this.outgoingMessage.messageId
                    ? ((e = !0),
                      this.displayMessages({ message: s, isIncoming: !0 }))
                    : this.displayMessages({ message: s });
                }
                this.outgoingMessage &&
                  !e &&
                  ...
                  setTimeout(function () {
                    t.barMessageId
                      ? (t.scrollToEl(t.barMessageId), t.checkBarPosition())
              ...
              handleAgentsAvatarToolbar: function () {
                if (this.$refs["tawk-home-header"]) {
                  ...
                  this.$refs["tawk-chat-panel"].scrollTop > t
                  ...
                  t.initialized
                    ? a(
                        ...
                        [
                          ...
                          t.isWebrtcEnabled ? a("call-widget") : t._e(),
                          a(
                            "tawk-overlay",
                            {
                              ref: "view-overlay",
                          ...
                          t.isInactive ? a("inactive-overlay") : t._e(),
                          ...
                          a(
                            ...
                            [
                              ...
                              a("maximize-footer", { ref: "main-footer" }),
                            ],
                            1
                          ),
                          a(
        ...
        r = Object(i.a)(
          ...
          function () {
            var t = this,
              e = t.$createElement,
              a = t._self._c || e;
            return a("div", { staticClass: "file-upload-progress" }, [
              a("div", [t._v(t._s(t.fileName))]),
              a(
                "div",
          ...
          methods: {
            ...
            formatFields: function (t) {
              for (var e = [], a = 0; a < t.length; a++) {
                ...
                if (
                  (i.required &&
                    (r.required = this.$i18n("form", "RequiredErrorMessage")),
                  i.context &&
                    "email" === i.context &&
                    ((r.email = this.$i18n("form", "EmailErrorMessage")),
                    (n = this.email)),
                  i.context && "name" === i.context && (n = this.name),
                  i.context &&
                    "phone" === i.context &&
                    (r.phone = this.$i18n("form", "PhoneErrorMessage")),
            ...
            formatFormData: function () {
              ...
              for (var a = 0; a < this.formFields.length; a++) {
                var s = this.formFields[a],
                  r = s.value || "";
                if (("string" == typeof r && (r = r.trim()), "name" === s.type))
                  t.name = r;
                else if ("email" === s.type) t.email = r;
                else if ("phone" === s.type && r.length > 0)
                  (r = r.replace(/[- )(]/g, "")), (t.phone = r);
                ...
                s.isRequired &&
                  ...
                  "department" !== s.type &&
                  (this.$refs[s.id] &&
                    this.$refs[s.id].length &&
                    this.$refs[s.id][0] &&
                    this.$refs[s.id][0].validate &&
                    this.$refs[s.id][0].validate(),
                  (e = !0)),
                  s.isError
                    ? (e = !0)
        ...
        e.a = {
          ...
          mounted: function () {
            ...
            t.Tawk_Window.eventBus.$on("widgetOnFocus", function (t) {
              e.$refs["toolbar-button"] &&
                !e.$refs["toolbar-button"].$el.contains(t.target) &&
                (e.isOpen = !1);
            });
          },
        };
                          ...
                          [
                            a(
                              ...
                              [
                                ...
                                t._v(
                                  " " +
                                    t._s(t.$i18n("form", "StartChatButton")) +
                                    " "
                                ),
                              ],
                              1
